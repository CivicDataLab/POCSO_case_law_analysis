...
The data analysis was part of a feasibility study on POCSO case laws acquired through eCourts. We're now collaborating with HAQ - Centre for Child Rights for a detailed study on the implementation of the POCSO law in the states of Assam, Delhi and Haryana. Read more [here..](https://www.notion.so/Child-Rights-Law-Implementation-Tracker-5ea2d8e7d33c4e2a9b69727a556523d3)
...
_Note: This page will not be updated further. The contents on this page are for information purposes only. No claim is made as to the accuracy or currency of the content on this site at any time. Information, data and advice on this website is provided on the basis that site users undertake responsibility for assessing the relevance and accuracy of its content._
