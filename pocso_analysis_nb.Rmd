...
ggplot(monthly_cases, aes(x = month_date, y=total_cases_registered)) +geom_bar (stat = 'identity') + xlab('Year') + ylab('# registered cases') + ggtitle('Month wise trend of case registrations') + theme_minimal()
